...
router.get('/get/hotel/:id', adminController.getHotelByIdHotel)
...
router.delete('/hotel/:id', adminController.deleteHotelById)
router.post('/confirm-delete-hotel/:id', adminController.confirmDeleteHotelById)
